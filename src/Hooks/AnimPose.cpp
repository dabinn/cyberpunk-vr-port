...
if (g_VRRecordFK) {
    cvr::anim::VrikPublishAnimatedFk(boneBuf);
                ...
                // Record the authored arm pose before either weapon writer below changes it. Head Aim
                // re-anchors this same pose in hip and ADS, so entering ADS cannot change its base frame.
