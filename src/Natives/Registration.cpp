...
RED4EXT_C_EXPORT void RED4EXT_CALL PostRegisterTypes() {
    ...
    auto fMainPos = RED4ext::CGlobalFunction::Create("VRMainCameraWorldPos", "VRMainCameraWorldPos", &VRMainCameraWorldPos);
    fMainPos->flags = flags; fMainPos->SetReturnType("Vector4"); rtti->RegisterFunction(fMainPos);
    auto fMainRot = RED4ext::CGlobalFunction::Create("VRMainCameraWorldRot", "VRMainCameraWorldRot", &VRMainCameraWorldRot);
    fMainRot->flags = flags; fMainRot->SetReturnType("Quaternion"); rtti->RegisterFunction(fMainRot);
    auto fVrcamPos = RED4ext::CGlobalFunction::Create("VRVrcamWorldPos", "VRVrcamWorldPos", &VRVrcamWorldPos);
    fVrcamPos->flags = flags; fVrcamPos->SetReturnType("Vector4"); rtti->RegisterFunction(fVrcamPos);
    auto fMainSeq = RED4ext::CGlobalFunction::Create("VRMainCameraSeq", "VRMainCameraSeq", &VRMainCameraSeq);
    fMainSeq->flags = flags; fMainSeq->SetReturnType("Int32"); rtti->RegisterFunction(fMainSeq);
    auto fWorldEntityStatus = RED4ext::CGlobalFunction::Create("VRWorldEntityStatus", "VRWorldEntityStatus", &VRWorldEntityStatus);
    fWorldEntityStatus->flags = flags; fWorldEntityStatus->SetReturnType("Int32");
    fWorldEntityStatus->AddParam("handle:IScriptable", "entity"); rtti->RegisterFunction(fWorldEntityStatus);
    auto fWorldEntityReady = RED4ext::CGlobalFunction::Create("VRWorldEntityReady", "VRWorldEntityReady", &VRWorldEntityReady);
    fWorldEntityReady->flags = flags; fWorldEntityReady->SetReturnType("Bool");
    fWorldEntityReady->AddParam("handle:IScriptable", "entity"); rtti->RegisterFunction(fWorldEntityReady);
