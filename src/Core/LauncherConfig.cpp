...
void EnsureLiveControlFileExists() {
    ...
    fprintf(file, "xr_veh_head_offset_x=0.0000\n");
    fprintf(file, "xr_veh_head_offset_y=0.0000\n");
    fprintf(file, "xr_veh_head_offset_z=0.0000\n");
    fprintf(file, "xr_wheel_grab=1\n");
    fprintf(file, "xr_wheel_radius=0.280\n");
    fprintf(file, "xr_wheel_steer_max_deg=90.0\n");
    fprintf(file, "xr_wheel_steer_dead_deg=1.5\n");
    fprintf(file, "xr_wheel_horn=0\n");
    fprintf(file, "xr_wheel_horn_radius=0.120\n");
    fprintf(file, "xr_vehicle_gun_trigger=1\n");
    fprintf(file, "xr_vehicle_throttle_trim=0.50\n");
    ...
    fprintf(file, "xr_body_yaw_follow_dead_deg=25.0\n");
