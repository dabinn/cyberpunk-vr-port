...
void PollLiveControls() {
    ...
    int xrVrikPlayStyle = g_liveControls.xrVrikPlayStyle;
    ...
    while (fgets(line, sizeof(line), file)) {
        ...
        if (sscanf_s(line, "xr_vrik_play_style=%d", &intValue) == 1 ||
            sscanf_s(line, "xr_vrik_play_style = %d", &intValue) == 1) {
            xrVrikPlayStyle = intValue;
            continue;
        }
    ...
    g_liveControls.xrVrikPlayStyle = xrVrikPlayStyle != 0 ? 1 : 0;
...
LiveControlsUiState MakeLiveControlsUiState() {
    ...
    state.xrVrikPlayStyle = g_liveControls.xrVrikPlayStyle;
...
void PersistLiveControlsUiState(const LiveControlsUiState& state) {
    ...
    fprintf(file, "xr_vrik_play_style=%d\n", state.xrVrikPlayStyle != 0 ? 1 : 0);
...
extern "C" void SetLiveControlsUiState(const LiveControlsUiState* state, int persistToFile) {
    ...
    g_liveControls.xrVrikPlayStyle = state->xrVrikPlayStyle != 0 ? 1 : 0;
